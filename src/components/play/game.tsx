    ...
    <div className="flex flex-col items-center justify-center gap-3 h-1 flex-1">
      ...
      >
        <div className="card__content text-center relative p-20 transition-transform duration-1000 font-bold">
          <div className="card__front absolute w-[380px] h-[200px] max-w-[100%] px-12 py-4 top-0 bottom-0 right-0 left-0 p-8 bg-white flex flex-col items-center justify-center rounded-lg gap-5">
            <h3 className="text-sm">Can you guess?</h3>
            <p className="font-medium text-md">
              Hint: <i className="font-normal">{flashcard.hint}</i>
            </p>
          </div>
          <div className="card__back absolute w-[380px] h-[200px] max-w-[100%] px-12 py-4 top-0 bottom-0 right-0 left-0 p-8 bg-white flex flex-col items-center rounded-lg justify-evenly">
